...
* def rrTab = "//a[text()='RR']"
And waitFor(rrTab).click()

And waitForUrl('/configuration/rr')
...
* def rrConfigOption = "span[data-name='RRConfigurationComponent']"
And waitFor(rrConfigOption).click()
And delay(3000)


* def macConfigOption = "//span[normalize-space()='MAC Configuration']"
And waitFor(macConfigOption).click()
And delay(3000)
...
* def expectedFileName = 'RRConf__sector-3.csv' 
