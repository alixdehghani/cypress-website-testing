...
* def sibTab = "//a[text()='SIB']"
And waitFor(sibTab).click()

And waitForUrl('/configuration/sib')
...
* def sibConfigOption = "span[data-name='SIB Configuration']"
And waitFor(sibConfigOption).click()

* def sib1Option = "span[data-name='SIB1']"
And waitFor(sib1Option).click()
...
* def expectedFileName = 'SIBConf__sector-3.csv' 
